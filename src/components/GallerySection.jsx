        ...
        <section id="gallery" className="bg-light text-dark py-5">
            <div className="container text-center">
                ...
                <div className="row row-cols-1 row-cols-md-2 row-cols-xl-3 g-4">
                    <Card
                        imgSrc="/img/photos/Street Meeting Poland 2024-139.webp"
                        imgAlt="Czeno biały nissan"
                    />
                    <Card
                        imgSrc="/img/photos/Street Meeting Poland 2024-252.webp"
                        imgAlt="Czeno biały nissan"
                    />
                    <Card
                        imgSrc="/img/photos/2024.03.29 Street Meeting 2-13.webp"
                        imgAlt="Czeno biały nissan"
                    />
                </div>
            </div>
