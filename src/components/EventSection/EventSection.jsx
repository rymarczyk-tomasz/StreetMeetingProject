  ...
  return (
    <section id="event" className={styles.event}>
      <div className={styles.container}>
        ...
        >
          <Card
            imgSrc={buildAssetPath("/photos/10.webp")}
            ...
            imgHeight="300px"
            content={`
                        <strong>Zarezerwuj swoje miejsce już teraz!</strong> Bilety na wydarzenie kupisz <a href="https://bkb.pl/151648-edcca" target="_blank" rel="noopener noreferrer" class="${styles.eventLink}" data-track="Kup bilety" aria-label="Kup bilety na Street Meeting Poland 2025">tutaj</a>.<p style="margin-top: 1rem;"> <strong>Zyskaj 15% zniżki!</strong> Zapisz się do naszego newslettera i odbierz kod rabatowy na bilet. Formularz zapisu znajdziesz na dole strony!</p>
                      `}
            isHtml={true}
          />
          <Card
            imgSrc={buildAssetPath("/photos/6.webp")}
          ...
          />
          <Card
            imgSrc={buildAssetPath("/photos/7.webp")}
