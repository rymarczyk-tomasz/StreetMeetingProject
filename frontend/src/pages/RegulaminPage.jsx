const REGULAMIN_HTML = `
<h1>Regulamin Wydarzenia „STREET SHOW 2026”</h1>
...
<section>
    ...
    <ol>
        ...
        <li>
            ...
            <strong>29 sierpnia 2026 roku</strong> na terenie
            stadionu Polsat Plus Arena Gdańsk, przy ul. Pokoleń
            Lechii Gdańsk 1, zwanym dalej „<strong>Terenem Wydarzenia</strong>”.
        </li>
        <li>
        ...
        <li>
            ...
            Regulaminu. Każda osoba korzystająca z biletu wchodzi na
            teren Wydarzenia na własną odpowiedzialność i
            zobowiązuje się do przestrzegania zasad Regulaminu.
        </li>
        <li>
        ...
        <li>
            ...
            na terenie Imprezy w trakcie jej trwania. Osoby
            przebywające na terenie Imprezy w trakcie jej trwania
            obowiązane są do bezwzględnego przestrzegania
            postanowień w nim zawartych. Każdy Uczestnik jest
            zobowiązany zachowywać się w sposób niezagrażający
            bezpieczeństwu innych Uczestników, a w szczególności
            przestrzegać postanowień Regulaminu Wydarzenia,
            Regulaminu obiektu oraz przepisów prawa, jak również
            stosować się do poleceń Służb Porządkowych i Służb
            Organizatora.
        </li>
        <li>
        ...
        <li>
            Poprzez „<strong>Służby Porządkowe</strong>” i „<strong>Służby Organizatora</strong>” należy rozumieć osoby, legitymujące się
...
<section>
    ...
    <ol>
        ...
        <li>
            ...
            jeden Uczestnik.
            <strong>W przypadku jej uszkodzenia traci ona ważność</strong>, a tym samym Uczestnik
            <strong>traci prawo do uczestniczenia w Wydarzeniu</strong>.
        </li>
        <li>
...
<section>
    ...
    <ol>
        ...
        <li>
            W przypadku, gdy
            <strong>Uczestnikiem Wydarzenia chce być małoletni w wieku poniżej 15 lat</strong>, może on uczestniczyć w Imprezie wyłącznie
            <span class="underline"
        ...
        <li>
            <strong>Organizator zastrzega sobie prawo odmówić wstępu na Teren Wydarzenia osobie:</strong>
            <ul class="alphanumeric">
                <li>
        ...
        <li>
            <strong>Ocena przedmiotów i kwalifikowanie ich, jako niebezpiecznych należy do Służb Porządkowych.</strong>
        </li>
        <li>
            <strong>Każde wejście na teren Wydarzenia, niezależnie od sposobu uzyskania biletu, oznacza akceptację Regulaminu przez osobę wchodzącą. Uczestnik zobowiązuje się przestrzegać zasad określonych w Regulaminie, który jest dostępny w punkcie sprzedaży oraz na stronie internetowej Organizatora.</strong>
        </li>
    </ol>
</section>
...
<section>
    ...
    <ol>
        ...
        <li>
            ...
            szczególności
            <strong>przestrzegać postanowień niniejszego regulaminu oraz regulaminu obiektu</strong>, w którym odbywa się Wydarzenie. Zakazane jest
        ...
        <li>
            <strong>Uczestnicy zobowiązani są bezwzględnie do:</strong>
            <ul class="alphanumeric">
                <li>
        ...
        <li>
            <strong>Opiekunowie osób niepełnoletnich zobowiązani</strong> są do pełnej kontroli osób pozostających pod ich opieką
        ...
        <li>
            ...
            <span class="underline">podstawą do usunięcia uczestnika z Terenu Wydarzenia</span>.
            <strong>Samowolne opuszczenie terenu Wydarzenia z uszkodzoną lub zerwaną Opaską jest równoznaczne z rezygnacją z uczestnictwa w Wydarzeniu i innych związanych.</strong>
        </li>
        <li>
        ...
        <li>
            <strong>Biorąc udział w Wydarzeniu Uczestnik wyraża zgodę na korzystanie przez Organizatora z wizerunku utrwalonego</strong>
        ...
        <li>
            Na terenie wydarzenia obowiązuje bezwzględny zakaz
            wchodzenia na murawę stadionu.
            <ul class="alphanumeric">
                <li>
                    Uczestnicy mogą poruszać się wyłącznie na
                    wyznaczonych ciągach komunikacyjnych wokół
                    murawy oraz w oznaczonych strefach wydarzenia.
                </li>
                <li>
                    Każde wejście na murawę bez zgody Organizatora
                    skutkuje nałożeniem kary umownej w wysokości 15
                    000 PLN za każdą osobę naruszającą ten zakaz.
                </li>
                <li>
                    Uczestnik, biorąc udział w wydarzeniu i
                    akceptując niniejszy regulamin, zobowiązuje się
                    do zapłaty kary umownej w przypadku złamania
                    tego zakazu.
                </li>
                <li>
                    W przypadku odmowy zapłaty Organizator ma prawo
                    dochodzić należności na drodze postępowania
                    cywilnego.
                </li>
                <li>
                    Uczestnicy zobowiązani są do bezwzględnego
                    stosowania się do poleceń Służb Porządkowych
                    oraz Służb Organizatora, które będą oznaczone
                    kamizelkami.
                </li>
                <li>
                    Osoby naruszające zakaz mogą zostać
                    natychmiastowo usunięte z wydarzenia bez prawa
                    do zwrotu biletu.
                </li>
                <li>
                    Organizator zastrzega sobie prawo do wezwania
                    odpowiednich służb porządkowych lub Policji w
                    przypadku naruszenia zakazu.
                </li>
                <li>
                    Organizator nie ponosi odpowiedzialności za
                    jakiekolwiek szkody wyrządzone przez
                    uczestników, którzy naruszyli zakaz wchodzenia
                    na murawę, ani za konsekwencje ich działań.
                    Uczestnicy wchodzący na murawę ponoszą pełną
                    odpowiedzialność cywilnoprawną za ewentualne
                    szkody wyrządzone Organizatorowi, właścicielowi
                    stadionu lub osobom trzecim.
                </li>
                <li>
                    Uczestnicy wydarzenia wchodzą na teren imprezy
                    na własną odpowiedzialność i zobowiązują się do
                    przestrzegania zasad regulaminu. Organizator nie
                    odpowiada za jakiekolwiek konsekwencje
                    zdrowotne, finansowe czy prawne wynikające z
                    naruszenia zakazu wchodzenia na murawę.
                </li>
                <li>
                    Organizator zastrzega sobie prawo do dochodzenia
                    roszczeń od uczestnika, który poprzez wejście na
                    murawę wyrządził szkodę materialną lub
                    niematerialną. W takim przypadku Organizator
                    może żądać pokrycia strat oraz wszelkich kosztów
                    wynikających z naruszenia regulaminu, w tym
                    kosztów postępowań prawnych.
                </li>
                <li>
                    Organizator nie ponosi odpowiedzialności za
                    ewentualne roszczenia właściciela stadionu w
                    związku z naruszeniem zakazu wchodzenia na
                    murawę przez uczestników. Wszelkie kary nałożone
                    przez właściciela obiektu na Organizatora w
                    wyniku działań uczestników mogą zostać
                    przeniesione na osoby, które naruszyły ten
                    zakaz.
                </li>
            </ul>
        </li>
        <li>
            Użycie drona w trakcie wydarzenia:
            <ul class="alphanumeric">
                <li>
                    Na terenie wydarzenia Street Show 2026 będzie
                    używany dron rejestrujący zdjęcia i nagrania
                    wideo z lotu nad przestrzenią publiczną, również
                    w pobliżu lub nad uczestnikami wydarzenia. Dron
                    będzie obsługiwany przez uprawnionego operatora
                    działającego na zlecenie Organizatora, zgodnie z
                    obowiązującymi przepisami prawa, w tym
                    przepisami Urzędu Lotnictwa Cywilnego oraz Unii
                    Europejskiej dotyczącymi lotów bezzałogowych
                    statków powietrznych.
                </li>
                <li>
                    Materiały zarejestrowane z użyciem drona będą
                    wykorzystywane w celach dokumentacyjnych,
                    informacyjnych i promocyjnych wydarzenia, w tym
                    m.in. na stronach internetowych, w mediach
                    społecznościowych, materiałach reklamowych i
                    prasowych.
                </li>
                <li>
                    Biorąc udział w wydarzeniu, Uczestnik wyraża
                    zgodę na możliwość utrwalenia jego wizerunku w
                    ramach rejestracji grupowej (np. jako część
                    tłumu) i jego nieodpłatne wykorzystanie przez
                    Organizatora oraz jego oficjalnych partnerów i
                    sponsorów.
                </li>
            </ul>
        </li>
...
<section>
    ...
    <ol>
        <li>
            ...
            administratorem danych osobowych Uczestników. Dane
            osobowe Uczestników przetwarzane są zgodnie z
            Rozporządzeniem Parlamentu Europejskiego i Rady (UE)
            2016/679 z dnia 27 kwietnia 2016 r. (RODO). Podstawą
            prawną przetwarzania danych osobowych jest:
            <ul class="alphanumeric">
                <li>
                    art. 6 ust. 1 lit. b RODO – przetwarzanie
                    niezbędne do wykonania umowy związanej z
                    uczestnictwem w Wydarzeniu,
                </li>
                <li>
                    art. 6 ust. 1 lit. c RODO – wypełnienie
                    obowiązków prawnych ciążących na
                    Administratorze,
                </li>
                <li>
                    art. 6 ust. 1 lit. f RODO – prawnie uzasadniony
                    interes Administratora polegający na organizacji
                    wydarzenia, zapewnieniu bezpieczeństwa oraz
                    dochodzeniu roszczeń.
                </li>
            </ul>
        </li>
        <li>
            Dane osobowe Uczestników będą przechowywane przez okres
            niezbędny do realizacji celów związanych z organizacją
            Wydarzenia, a następnie przez okres wymagany przepisami
            prawa lub do czasu przedawnienia ewentualnych roszczeń
            wynikających z udziału w Wydarzeniu.
        </li>
        <li>
            ...
            Dane osobowe Uczestników mogą być przekazywane podmiotom
            współpracującym z Organizatorem przy realizacji
            Wydarzenia, w szczególności:
            <ul class="alphanumeric">
                <li>podmiotom obsługującym sprzedaż biletów,</li>
                <li>
                    podmiotom świadczącym usługi informatyczne i
                    hostingowe,
                </li>
                <li>
                ...
                <li>
                    służbom porządkowym oraz podmiotom
                    odpowiedzialnym za bezpieczeństwo wydarzenia,
                </li>
                <li>
                    organom publicznym uprawnionym do uzyskania
        ...
        <li>
            Podczas Wydarzenia mogą być wykonywane zdjęcia oraz
            nagrania wideo w celach dokumentacyjnych i promocyjnych.
            Materiały te mogą zostać opublikowane w szczególności na
            stronach internetowych, w mediach społecznościowych oraz
...
export default function RegulaminPage() {
    return (
        <div
            className="container my-5 regulamin-page"
            // Long legal text kept verbatim from the original regulamin.html.
            dangerouslySetInnerHTML={{ __html: REGULAMIN_HTML }}
        />
    );
}
